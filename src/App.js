...
function App() {
  ...
  const submitHandler  = async (e)=>{
    e.preventDefault() //page reload na ho use prevendeafauit
    ...
    <Box bg={"red.50"}>
      {user ? (
        <Container h={"100vh"} bg={"white"}>
          {/* VStack ye ek div he jiski display flex ho rkhi he ad flex-dirextion coloum ho rkhi he */}
        ...
        <VStack justifyContent={"center"} height="100vh">
          <Button onClick={loginHandler} colorScheme={"pink"}>
            SIgnIN with google
          </Button>
        </VStack>
      )}
